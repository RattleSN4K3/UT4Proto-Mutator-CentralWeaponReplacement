class TestCWR_RipperAttachment extends UTAttachment_Translocator;
...
DefaultProperties
{
	Begin Object Class=MaterialInstanceConstant Name=MyMaterialInstanceAttachment
		...
		VectorParameterValues.Add((ParameterName="Diffuse_01_Color",ParameterValue=(R=0.0,G=1.0,B=0.0,A=1.0)))
	End Object
